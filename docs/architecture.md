> ⚠️ **已废弃（2026-09-22，SPEC-20260922-04 / M6 文档真源收敛）**：本文描述的是 V10 时代的架构设想，与当前实现已有显著偏差。
> 现行真源：**`docs/architecture/逆向架构Spec_V16_2026-09-22.md`**（分层依赖实测图 / 数据模型 / 关键运行链路 / 线程与并发边界 / 债务台账 A1–A10）。
> 本文仅作历史留存，**勿据此改代码**。
